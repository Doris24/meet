...
const credentials = {
  ...
  redirect_uris: ["https://doris24.github.io/meet"],
  javascript_origins: ["https://doris24.github.io", "http://localhost:3000"],
};
...
/**
 * get Access Token
 * 1. Create the function and export it using Node.js module exports.
 * 2. Update the “serverless.yml” file to tell serverless what the function is and how to deploy it.
 */
...
/**
 * Lambda function that passes the access token to the Google Calendar API
